 ...
 * @author cfuen
 */
public class Poductos extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Poductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
